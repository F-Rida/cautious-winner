...
cat = Label(root, text="OILS", fg="black",font=("Times",32,'bold'),bg="lightgreen")
cat.place(x=600,y=20)
...
items = [["Coconut Oil"], ["Desi Ghee"], ["Mustard Seed Oil"], ["Olive Oil"], ["Sunflower Seed Oil"]]




checklist = tk.Text(root, width=20,bg="lightgreen",height=20)
checklist.place(x=580,y=200)

for i in items:
    var = tk.IntVar()
    i.append(var)
    checkbutton = tk.Checkbutton(checklist, text=i[0], variable=var,cursor="arrow",bg="green",fg="white",height=2)
