...
cat = Label(root, text="VEGETABLES", fg="black",font=("Times",32,'bold'),bg="lightgreen")
...
items = [["Bottleguard"], ["Cabbage"], ["Coriander"], ["Green Chilli"], ["Lemon"],["Mint Leaves"],["Onions"],["Potato"],["Red Chilli"],["Spinach"]]
