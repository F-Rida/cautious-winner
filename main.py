...
path_page = Frame(root, height = 600, width = 1250, bg='lightgreen', bd=5, relief=RIDGE)
...
header = Label(path_page, text="SHORTEST PATH", fg="black",
               font=("Times New Roman",32,'bold'),
               background="lightgreen")
header.place(x=480, y=50)
